  ...
  return knex('table_name').del()
    .then(function () {
      ...
      return knex('table_name').insert([
        {id: 1, name: 'Max Turner', class: 'Fighter', race: 'Human', weight: '120', gender: 'Female', size: 'Medium', description: "Max Turner hasn't had time to gain any experance just yet "},
